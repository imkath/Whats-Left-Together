...
export default function SourcesSection({ compact = false, showTitle = true }: SourcesSectionProps) {
  ...
  return (
    <div>
      {showTitle && (
        <h3 className="text-2xl font-bold mb-6">Fuentes de datos oficiales</h3>
      )}
      ...
      <div className="mt-6 p-4 bg-neutral-100 rounded-lg">
        <p className="text-sm text-neutral-700">
          ...
          Puedes verificar la metodología completa, revisar el código fuente, y validar los cálculos.
        </p>
        <a
