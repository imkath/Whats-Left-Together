      ...
      <div className="container-custom py-12 max-w-4xl">
        ...
        <div className="card mb-8">
          <p className="text-lg text-neutral-700 leading-relaxed">
            Este proyecto no predice el futuro. Utiliza <strong>tablas de vida demográficas oficiales</strong> para
            aproximar cuántas veces más podrías ver en persona a alguien importante, si las condiciones
            actuales se mantienen. Es un <strong>espejo estadístico</strong>, no una sentencia.
          </p>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="card">
            ...
            <p className="text-neutral-700">
              Basado en la probabilidad de que ambos estén vivos en cada año futuro,
              multiplicado por la frecuencia de visitas que mantienes actualmente.
            </p>
          </div>
        </section>
            ...
            <div className="card border-primary-300 bg-primary-50">
              <div className="mb-3 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-primary-700 mt-1 font-medium">Fuente principal de datos</p>
                </div>
              </div>

              <div className="text-neutral-700 space-y-2 text-sm">
                <p><strong>Qué proporciona:</strong></p>
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>Tablas de vida por edad, país y sexo</li>
                  <li>Esperanza de vida residual (e<sub>x</sub>)</li>
                  <li>Probabilidad de supervivencia año a año</li>
                  <li>Cobertura: 237 países y áreas</li>
                </ul>

                <p className="mt-3"><strong>Organización:</strong> Naciones Unidas, División de Población</p>
                <p><strong>Actualización:</strong> 2024 (revisión más reciente)</p>
            ...
            <div className="card">
              ...
              <div className="space-y-3 text-sm">
                <div className="border-l-2 border-primary-500 pl-3">
                  <div>
                    <strong>WHO Global Health Observatory</strong> - Validación cruzada de datos de mortalidad
                    <br />
                ...
                <div className="border-l-2 border-primary-500 pl-3">
                  <div>
                    <strong>Human Mortality Database</strong> - Precisión adicional para países con buena estadística
                    <br />
                    <a href="https://www.mortality.org" target="_blank" rel="noopener noreferrer"
                       className="text-primary-600 hover:text-primary-700">
                      www.mortality.org
                    </a>
                  </div>
            ...
            <ul className="space-y-3 text-neutral-700">
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600 mt-1">
                    Si actualmente ves a la persona 12 veces al año, asumimos que eso continuará.
                    En la realidad puede aumentar o disminuir.
                  </p>
                </div>
              </li>
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600 mt-1">
                    Las tablas de vida representan la experiencia promedio de una población,
                    no consideran salud individual.
                  </p>
                </div>
              </li>
        ...
        <section className="mb-12">
          ...
          <div className="card bg-red-50 border-red-300 border-l-4">
            <ul className="space-y-2 text-neutral-800 list-disc list-inside">
              <li><strong>No predice cuándo morirá nadie</strong></li>
              <li><strong>No debe usarse para decisiones médicas</strong></li>
              <li><strong>No reemplaza el juicio personal o consejo profesional</strong></li>
              <li><strong>No incorpora eventos imprevistos (accidentes, pandemias, etc.)</strong></li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-4 flex items-center gap-3">
            5. <BookOpen size={28} className="text-primary-700" /> Por qué creemos que mostrar este número es útil
          </h2>
          ...
          <div className="card border-primary-300">
            ...
            <div className="prose prose-neutral max-w-none">
              <p className="text-neutral-700">
                La <strong>Teoría de la Selectividad Socioemocional</strong> (Carstensen, 1999, 2021)
                demuestra que cuando las personas perciben que su tiempo futuro es limitado,
                priorizan relaciones cercanas y metas emocionales por encima de la exploración
                o acumulación de información.
              </p>

              <p className="text-neutral-700 mt-3">
                La gente tiende a <strong>subestimar cuán finito es su tiempo</strong> con los demás.
                Un número concreto ayuda a tomar decisiones más conscientes sobre prioridades.
              </p>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-4">Contexto: Uso del tiempo a lo largo de la vida</h2>

          <div className="card">
            <p className="text-neutral-700 mb-4">
              Datos del <strong>American Time Use Survey</strong> (Bureau of Labor Statistics, EE.UU.)
              y análisis de <strong>Our World in Data</strong> muestran que:
            </p>
            ...
            <p className="text-neutral-700 mt-4">
              Esto significa que <strong>la mayoría del tiempo ya se consumió</strong>,
              incluso cuando ambos siguen vivos.
            </p>
        ...
        <section className="mb-12">
          ...
          <div className="card">
            ...
            <div className="space-y-4 text-neutral-700 text-sm">
              <div>
                <strong>1. Esperanza de vida residual (e<sub>x</sub>):</strong>
                <p className="mt-1">
              ...
              <div>
                ...
                <p className="mt-1">
                  P(sobrevivir de edad <em>a</em> a edad <em>a+t</em>) = l<sub>a+t</sub> / l<sub>a</sub>
                </p>
                <p className="text-xs text-neutral-600 mt-1">
                  Donde l<sub>x</sub> es el número de supervivientes a edad x (de cohorte inicial de 100,000)
                </p>
              </div>
            ...
            <div className="mt-6 pt-6 border-t border-neutral-200">
              <p className="text-sm text-neutral-600">
                <strong>Referencia metodológica:</strong> Preston, S. H., Heuveline, P., & Guillot, M. (2001).
                <em>Demography: Measuring and Modeling Population Processes</em>. Blackwell Publishers.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="card">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-neutral-700 mb-6" start={4}>
              <li>
              ...
              <li>
                ...
                <a href="https://www.bls.gov/tus/" target="_blank" rel="noopener noreferrer"
                   className="text-primary-600 hover:text-primary-700">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-neutral-700" start={6}>
              <li>
                ...
                in Human Motivation. <em>The Gerontologist</em>, 61(8), 1188–1196.{' '}
                <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC8599276/" target="_blank" rel="noopener noreferrer"
                   className="text-primary-600 hover:text-primary-700">
              ...
              <li>
                ...
                A theory of socioemotional selectivity. <em>American Psychologist</em>, 54(3), 165–181.
              </li>
            </ol>
          </div>
        </section>
